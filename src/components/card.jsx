    ...
    <div className="relative p-6 border shadow-md rounded-2xl w-full max-w-[404px] min-h-[285px] gap-6 flex flex-col bg-black-50">
      ...
      <div className="flex justify-between">
        <div className="flex flex-wrap space-x-2 sm:space-x-3">
          ...
          <span className="px-2.5 py-1 text-xs font-light bg-green-100 rounded-full text-black-50 bg-tag-green">
            주거
          </span>
        </div>
        {/* 즐겨찾기 아이콘 */}
      ...
      {/* 제목 & 설명 */}
      <div className="gap-3.5 flex flex-col min-h-[108px]">
        {/* 제목 */}
      ...
      <div className="flex justify-end h-[40px]">
        <button className="w-[150px] h-full px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100">
          자세히 보기
        </button>
      </div>
    </div>
